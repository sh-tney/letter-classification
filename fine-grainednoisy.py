...
SaveFigures = False
LoadFromFile = True
Iteration = "FG42FineGrainNoisyFinal" # Runs a model based on the structure in this file
# Iteration = "FG0.2Dupe74SimpleNoisyFinal" # Runs model based on the final Simple structure 
...
# Create and train a neural network model
   ...
   save_best = tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=Epochs/4, restore_best_weights=True)
