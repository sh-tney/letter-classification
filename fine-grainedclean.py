...
SaveFigures = False
LoadFromFile = True
Iteration = "FGC1FineGrainCleanFinal" # Runs a model based on the structure in this file
# Iteration = "FGC0.2Dupe74SimpleNoisyFinal" # Runs model based on the final Simple structure 
